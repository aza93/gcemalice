...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\ExploitBundle\\Entity')]);

$b->addDriver($c, 'Vich\\UploaderBundle\\Entity');
$b->addDriver($c, 'ExploitBundle\\Entity');
...
$a->setEntityNamespaces(['VichUploaderBundle' => 'Vich\\UploaderBundle\\Entity', 'ExploitBundle' => 'ExploitBundle\\Entity']);
